...
public class CatalogItem {
     ...
     */
    public static String[] CATEGORIES_DESC = {"Телефонные аппараты открытой ДС", "Телефонные аппараты ЗАС", "Оборудование терминальное и ЗВКС", "Кабель применяемый для развертывания абонентской сети", "Аппаратные тактического звена управления", "Аппаратные оперативного звена управления"};
